...
define([
    ...
    'text!./ContractStateDcoratorDecorator.DiagramDesignerWidget.html',
    'css!./ContractStateDcoratorDecorator.DiagramDesignerWidget.css'
], function (CONSTANTS, nodePropertyNames, DiagramDesignerWidgetDecoratorBase, ContractStateDcoratorDecoratorTemplate) {
    ...
    ContractStateDcoratorDecorator = function (options) {
    ...
    ContractStateDcoratorDecorator.prototype.$DOMBase = $(ContractStateDcoratorDecoratorTemplate);

    ContractStateDcoratorDecorator.prototype.on_addTo = function () {
        var self = this;
    ...
    ContractStateDcoratorDecorator.prototype._renderName = function () {
    ...
    ContractStateDcoratorDecorator.prototype.update = function () {
        var client = this._control._client,
            nodeObj = client.getNode(this._metaInfo[CONSTANTS.GME_ID]),
            newName = '';
    ...
    ContractStateDcoratorDecorator.prototype.getConnectionAreas = function (id /*, isEnd, connectionMetaInfo*/) {
        var result = [],
            edge = 10,
            LEN = 20;
    ...
    ContractStateDcoratorDecorator.prototype._onNodeTitleChanged = function (oldValue, newValue) {
        var client = this._control._client;
    ...
    ContractStateDcoratorDecorator.prototype.doSearch = function (searchDesc) {
