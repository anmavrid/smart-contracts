...
define([
...
], function (CONSTANTS, nodePropertyNames, DiagramDesignerWidgetDecoratorBase, ContractStateDecoratorTemplate) {
    ...
    ContractStateDecorator.prototype._renderName = function () {
